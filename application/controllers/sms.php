		...
		public function confirmCode(){
			...
			if ($query->num_rows() > 0 ) { // No confirm code
				foreach ($query->result_array() as $row) {
					...
					$peaceMsg = $sms_keyword.'#'.$senderid.'#Hi. Thank you for doing your part in this election & keeping peace. Let\'s give the IEBC time to do theirs. Share this via http://bit.ly/gtvke From: 0'.$senderno;
