<h2><?php echo $countyinfo['county_name']; ?> CONSTITUENCY 
...
<div class="tabbable"> <!-- Only required for left/right tabs -->
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#tab2" data-toggle="tab"><h4 style="margin: 0;">National Assembly Candidates</h4></a></li>
	</ul>
	<div class="tab-content">
		...
		<div class="tab-pane active" id="tab2">
			<div class="row">
				<?php foreach($nationalassembly_aspirants as $candidate){ ?>
					<div class="span4">
						<p><b><?php echo $candidate['surname']." ".$candidate['other_name']; ?></b></p>
						<small><?php echo $candidate['name']; ?></small>
						<p><b>Running mate: </b> <?php echo $candidate['running_mate']; ?></p>
