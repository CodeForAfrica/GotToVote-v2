...
if($_POST) {
	...
	if($core->validate_post($_POST) == true)
	{
		...
		} else if ($database->create_users_table($_POST) == false) {
			$message = $core->show_message('error',"The tables could not be created, please verify your settings.");
      ...
      $redir = str_replace('install/','user/admin_account',$redir); 
